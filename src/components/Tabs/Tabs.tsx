...
/**
 * Tabs Component
 * An accessible tabbed interface built on Radix UI
 * Supports keyboard navigation and ARIA patterns
 */
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      'bg-[var(--semantic-color-muted-default)]',
      'text-[var(--semantic-color-muted-foreground)]',
      className
    )}
    {...props}
  />
